...
def home():
    ...
    return render_template('index.html', form=form, todo_lists=all_forms,color_form=color_form(),black=color_database.query.get(1).black,green=color_database.query.get(1).green,red=color_database.query.get(1).red)
